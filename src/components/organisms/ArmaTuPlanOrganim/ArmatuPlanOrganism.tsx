...
import { Cobertura } from "../../molecules/ArmaTuPlan/Cobertura/Cobertura"
...
import { BoxBoyLic, BoxSum, BoxSumButtom, BoxSumButtomTrue, BoxSumButtomWrapper, BoxSumText, BoxSumTextMinMax, BoxText, Button, H2Reusable, H3Reusable, Line, NavCoberture, PReusable, TextWrapper, Wrapper, WrapperBody, WrapperBodyImportant, WrapperH3, WrapperMont, WrapperMontData, WrapperPlumbH3, WrapperSteps } from "./styles"
        ...
        <Wrapper>
            ...
            <WrapperBody>
                <WrapperBodyImportant>
                     <Volver/>
                    <H1 fontSize={'40px'} marginTop={'8px'}letterSpacing={'-0.6px'} >¡Hola, <H1Red fontSize={'40px'}>Juan!</H1Red></H1>
                    ...
                    <BoxBoyLic>
                        <BoxText>
                            ...
                            <PReusable fontSize={'21px'}  color={'#494F66'}>Wolkswagen 2019 Golf</PReusable>  
                        </BoxText>
                        <ChicoRimac/>
                    </BoxBoyLic>
                    <BoxSum>
                    ...
                    <Cobertura src1={"/images/llanta.svg"} text={"Agrega o quita coberturas"} src2={"/images/menos.svg"}                    />
                    <TextWrapper> <PReusable fontSize={'14px'}  color={'#676F8F'}>He salido de casa a las cuatro menos cinco para ir a la academia de ingles de mi pueblo (Sant Cugat, al lado de Barcelona) con mi bici, na llego a la academia que está en el centro del pueblo en una plaza medio-grande y dejo donde siempre la bici atada con una pitón a un sitio de esos de poner las bicis y mucho más </PReusable></TextWrapper>
